...
class OpenIdConfiguration {
  ...
  /// Creates a parsed provider configuration.
  OpenIdConfiguration({
  ...
  /// Creates an [OpenIdConfiguration] from discovery document JSON.
  factory OpenIdConfiguration.fromJson(
    ...
    responseTypesSupported: json["response_types_supported"] == null
        ? List<String>.empty()
        : List<String>.from(json["response_types_supported"] as List<dynamic>),
    responseModesSupported: json["response_modes_supported"] == null
        ? List<String>.empty()
        : List<String>.from(json["response_modes_supported"] as List<dynamic>),
    ...
    subjectTypesSupported: List<String>.from(
      (json["subject_types_supported"] ?? <List<String>>[]) as List<dynamic>,
    ),
